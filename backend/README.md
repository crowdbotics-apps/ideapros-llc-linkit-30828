...
## Project Structure
    ...
    ├── ideapros_llc_linkit_30828  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_linkit_30828`
...
2. Clone this repo and `cd ideapros_llc_linkit_30828`
